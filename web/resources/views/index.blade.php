                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Program Studi 1</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 2</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 3</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 4</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 5</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 6</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 7</a>
                                </li>
                                <li>
                                    <a href="#">Program Studi 8</a>
                                </li>
                                <li>
                                    <a href="#">Sub Bagian 1</a>
                                </li>
                                <li>
                                    <a href="#">Sub Bagian 2</a>
                                </li>
                                <li>
                                    <a href="#">Sub Bagian 3</a>
                                </li>
                                <li>
                                    <a href="#">Sub Bagian 4</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Persetujuan Anggaran</a>
                            
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Pelaksanaan Anggaran<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="">Pencairan Dana</a>
                                </li>
                                <li>
                                    <a href="">Rincian Penggunaan PAGU</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
