        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-body">
                    <form action="{{ route('spjup_update', $spjup->id) }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PATCH">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <label>Sub Bagian/Program Studi</label>
                            <select name="id_bagian" class="form-control">
                                <option value="{{ $spjup->ke_bagian->id }}">{{ $spjup->ke_bagian->detail }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                 <select name="id_akun" class="form-control">
                                    <option value="{{ $spjup->akun->id }}">({{ $spjup->akun->kode_akun }})  {{ $spjup->akun->uraian_akun }}</option>
                                    <option value="">-- Pilih  --</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="untuk_pembayaran" class="form-control">{{ $spjup->untuk_pembayaran }}</textarea>
                        </div>
                        <hr>                        
                        <div class="form-group">
                            <div class="col-md-6">
